...
{
    public class BolletPowerPrizeFactory : PrizeFactory
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override GameObject CreatePrize(Vector2 position)
        {
            ...
            gameObject.InitializeObjectComponent(new SpriteComponent(RenderingSystem.LoadBitmap("Resources/MazeElements/Prize/bullet_power.png")));
            ...
            speedPrize.InitializeGunSpawn(new PowerDecorator(new PlayerProperitiesStandart()), 5f);
